...
#define STRING_CONFIG_H_AUTHOR "(Rune Stene, CR20Pro config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rune is"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.00, 80.00, 400.00, 98.90 }
